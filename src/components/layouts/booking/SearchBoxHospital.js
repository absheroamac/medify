...
export const SearchBoxHospital = ({setCity,setState,state,handleSearch}) => {
  ...
  return (
    <Box sx={{backgroundColor:'primary.main',width:'100%',height:'110px'}}>
        ...
        <Box display={'flex'}>
        <Typography variant='h1' sx={{fontSize:'40px',color:'white.main',position:'absolute',top:'2rem'}}>My Bookings</Typography>
        <Box p={3} borderRadius={4} display={'flex'} justifyContent={'center'} gap={3} zIndex={1} sx={{backgroundColor:'white.main',position:'absolute', width:'70%',top:'4rem',right:0}}>
        <TextField
